...
//---------------------------- keyboard
bool GetKeyboardPress(int nKey);							//KEYが押されているかどうかのチェック
bool GetKeyboardTrigger(int nKey);							//押した瞬間に、一回だけ反応する
bool GetKeyboardRepeat(int nKey);							//ずっと押すと、連続に反応する
bool GetKeyboardRelease(int nKey);							//てが離した瞬間に、一回だけ反応する
